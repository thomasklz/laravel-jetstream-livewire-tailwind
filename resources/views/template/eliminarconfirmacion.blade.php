...
<div  wire:ignore.self class="hidden overflow-y-auto overflow-x-hidden fixed right-0 left-0 top-4 z-50 justify-center items-center md:inset-0 h-modal sm:h-full" id="popup-modal">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6 pt-0 text-center">
                ...
                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                   Estás seguro que deseas eliminar a: {{ $detalle }}?
                </h3>
                <button 
                wire:click="delete({{$idTipo}})" 
                ...
                <button data-modal-toggle="popup-modal" t
                ype="button" 
